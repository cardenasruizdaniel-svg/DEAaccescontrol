...
const STORES: StoreSchema[] = [
  ...
  { name: "shifts", keyPath: "id", indexes: [{ name: "employee_id", keyPath: "employee_id" }, { name: "status", keyPath: "status" }] },
  { name: "schedules", keyPath: "id", indexes: [{ name: "employee_id", keyPath: "employee_id" }, { name: "shift_date", keyPath: "shift_date" }] },
  ...
  { name: "audit_log", keyPath: "id", indexes: [{ name: "shift_id", keyPath: "shift_id" }, { name: "event", keyPath: "event" }, { name: "synced", keyPath: "synced" }] },
  { name: "active_timer", keyPath: "id" },
];
