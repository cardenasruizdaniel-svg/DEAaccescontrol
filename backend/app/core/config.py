...
class Settings(BaseSettings):
    ...
    # Database
    DATABASE_URL: str = "postgresql+asyncpg://dla:dla_password@localhost:5432/dla_access_enterprise"
    ...
    # CORS
    CORS_ORIGINS: list[str] = ["http://localhost:3000", "http://localhost:3001", "http://localhost:8080", "http://localhost:8082", "http://localhost:19006", "http://127.0.0.1:3000", "http://127.0.0.1:3001", "http://127.0.0.1:8080", "http://127.0.0.1:8082", "http://127.0.0.1:19006"]
    ...
    # Payroll - Colombian Legislation 2024
    MINIMUM_WAGE: int = 1300000
